...
document.addEventListener("DOMContentLoaded",(()=>{
    ...
    t.fileData.forEach((a=>{
        const n=a[e.Classification]||"", // (تطوير) اقرأ قيمة التصنيف من الملف
        l=C(n), // (تطوير) ابحث عن المفتاح المقابل
        i={Account:a[e.Account]||"",Value:i(a[e.Value]),Classification:l},
        d={};r.tables[s].fields.forEach((e=>d[e]=i[e])),t.data[s].push(d)
    })),
    // --- (نهاية التطوير) ---
