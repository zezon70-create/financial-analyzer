    ...
    const t = {
        ...
        r = {
            tables: {
                bs: {
                    headers: {
                        ar: ["الحساب", "القيمة", "التصنيف (مهم جداً)", "إجراء"],
                ...
                is: {
                    headers: {
                        ar: ["البند", "القيمة", "التصنيف (مهم جداً)", "إجراء"],
            ...
            let e = r.requiredFields.map((e => {
                const o = s(e),
                    n = ((e, t) => {
                        ...
                        return "account" === a && t.find((e => String(e).toLowerCase().trim().includes("item"))) ? t.find((e => String(e).toLowerCase().trim().includes("item"))) : "account" === a && t.find((e => String(e).toLowerCase().trim().includes("البند"))) ? t.find((e => String(e).toLowerCase().trim().includes("البند"))) : "value" === a && t.find((e => String(e).toLowerCase().trim().includes("amount"))) ? t.find((e => String(e).toLowerCase().trim().includes("amount"))) : "value" === a && t.find((e => String(e).toLowerCase().trim().includes("القيمة"))) ? t.find((e => String(e).toLowerCase().trim().includes("القيمة"))) : "classification" === a && t.find((e => String(e).toLowerCase().trim().includes("classification"))) ? t.find((e => String(e).toLowerCase().trim().includes("classification"))) : "classification" === a && t.find((e => String(e).toLowerCase().trim().includes("تصنيف"))) ? t.find((e => String(e).toLowerCase().trim().includes("تصنيف"))) : ""
                    })(e, t.fileHeaders);
                return `
            ...
            s.onload = e => {
                try {
                    ...
                    t.fileData = i, t.fileHeaders = Object.keys(i[0]), (() => {
                        if (0 === t.fileData.length) return void(l.filePreviewTable.innerHTML = `<p class="text-danger">${"ar"===a?"الملف فارغ أو لا يمكن قراءته.":"File is empty or unreadable."}</p>`);
