// js/benchmarks-app.js (Self-contained script for benchmarks.html - Dark Mode Fix + Nav Key)
...
window.pageTranslations = {
    ar: {
        ...
        navBenchmarks: "المقارنات المعيارية", // *** تمت إضافته لترجمة الرابط النشط ***
    ...
    en: {
        ...
        navBenchmarks: "Benchmarks", // *** ADDED for active link translation ***
