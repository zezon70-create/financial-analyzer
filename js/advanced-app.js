// js/advanced-app.js (Full Version + EVA Tab Added)
...
window.pageTranslations = {
    ar: { 
        ...
        tabEVA: "القيمة الاقتصادية المضافة (EVA)", // *** ADDED ***
        ...
        // *** ADDED: EVA Translations ***
        evaInputTitle: "مدخلات حساب (EVA)",
        evaInputDesc: "لحساب القيمة الاقتصادية المضافة، نحتاج إلى افتراضات خارجية.",
        labelWACC: "متوسط تكلفة رأس المال (WACC)",
        labelTaxRate: "معدل الضريبة الفعلي",
        evaResultsTitle: "نتائج تحليل القيمة الاقتصادية المضافة (EVA)",
        evaDataWarning: "لا توجد بيانات كافية من ميزان المراجعة لحساب (EVA). تأكد من وجود أصول، وخصوم، وأرباح قبل الفوائد والضرائب.",
        evaValueLabel: "القيمة الاقتصادية المضافة (EVA):",
        evaInterpretation: "التفسير:",
        evaInterpretationPositive: "🟢 خلق للقيمة: الشركة تحقق عائداً أعلى من تكلفة رأس المال، مما يزيد من ثروة المساهمين.",
        evaInterpretationNegative: "🔴 تدمير للقيمة: الشركة تحقق عائداً أقل من تكلفة رأس المال، مما يقلل من ثروة المساهمين.",
        evaComponents: "مكونات الحساب:",
        evaNOPAT: "صافي الربح التشغيلي بعد الضرائب (NOPAT)",
        evaInvestedCapital: "رأس المال المستثمر (IC)",
        evaCapitalCharge: "تكلفة رأس المال (IC x WACC)"
    },
    en: { 
        ...
        tabEVA: "Economic Value Added (EVA)", // *** ADDED ***
        // ... (rest of English translations for all 6 tabs) ...
        // *** ADDED: EVA Translations (English) ***
        evaInputTitle: "EVA Calculation Inputs",
        evaInputDesc: "To calculate Economic Value Added, we need external assumptions.",
        labelWACC: "Weighted Average Cost of Capital (WACC)",
        labelTaxRate: "Effective Tax Rate",
        evaResultsTitle: "Economic Value Added (EVA) Analysis",
        evaDataWarning: "Insufficient data from Trial Balance to calculate EVA. Ensure Assets, Liabilities, and EBIT components are available.",
        evaValueLabel: "Economic Value Added (EVA):",
        evaInterpretation: "Interpretation:",
        evaInterpretationPositive: "🟢 Value Creation: The company is generating returns higher than its cost of capital, increasing shareholder wealth.",
        evaInterpretationNegative: "🔴 Value Destruction: The company is generating returns lower than its cost of capital, diminishing shareholder wealth.",
        evaComponents: "Calculation Components:",
        evaNOPAT: "Net Operating Profit After Tax (NOPAT)",
        evaInvestedCapital: "Invested Capital (IC)",
        evaCapitalCharge: "Capital Charge (IC x WACC)"
    }
};

document.addEventListener('DOMContentLoaded', () => {

    // *** ADDED: Delay execution to ensure main.js is ready ***
    setTimeout(() => {
        ...
        // *** ADDED: EVA Calculation and Display Function ***
            ...
            tabs.forEach(tabId => {
                ...
                if (tabElement) {
                    tabElement.addEventListener('shown.bs.tab', () => {
                         ...
                         if (tabId === 'eva') calculateAndDisplayEVA(); // *** ADDED ***
