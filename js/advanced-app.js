...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const runAnalysis = (renderOnlyRatios = false) => {
        ...
        // Always render ratio category, but use the correct ID
    ...
    // *** No populateIndustrySelect needed here anymore ***
