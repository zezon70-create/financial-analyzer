const advancedTranslations = {
    ar: {
        ...
        tabVertical: "التحليل الرأسي",
        tabZScore: "نموذج Z-Score",
        tabCashFlow: "تحليل التدفقات النقدية",
        tabEVA: "القيمة الاقتصادية المضافة (EVA)",
        tabHorizontal: "التحليل الأفقي",
        tabCCC: "دورة التحول النقدي",
        tabScenario: "تحليل السيناريو",
        ...
        activityRatios: "مؤشرات النشاط",
        valuationRatios: "مؤشرات التقييم",
        currentRatio: "نسبة التداول",
        currentRatio_comment_high: "سيولة ممتازة...",
        currentRatio_comment_good: "سيولة جيدة...",
        currentRatio_comment_low: "مؤشر خطر...",
        quickRatio: "نسبة السيولة السريعة",
        quickRatio_comment_good: "قدرة جيدة...",
        quickRatio_comment_low: "مؤشر خطر...",
        netWorkingCapital: "صافي راس المال العامل",
        netWorkingCapital_comment_positive: "وضع صحي.",
        netWorkingCapital_comment_negative: "مؤشر خطر.",
        cashRatio: "نسبة النقد",
        cashRatio_comment_good: "قدرة قوية جداً.",
        cashRatio_comment_low: "اعتماد منخفض.",
        inventoryTurnover: "معدل دوران المخزون",
        inventoryTurnover_comment_high: "كفاءة عالية.",
        inventoryTurnover_comment_low: "ضعف أو ركود.",
        assetTurnover: "معدل دوران الأصول",
        assetTurnover_comment_high: "كفاءة ممتازة.",
        assetTurnover_comment_low: "كفاءة منخفضة.",
        receivablesTurnover: "معدل دوران العملاء",
        receivablesTurnover_comment_high: "تحصيل قوي.",
        receivablesTurnover_comment_low: "تباطؤ في التحصيل.",
        avgCollectionPeriod: "متوسط فترة التحصيل",
        avgCollectionPeriod_comment_low: "سرعة ممتازة.",
        avgCollectionPeriod_comment_high: "فترة طويلة.",
        debtToEquity: "نسبة الديون لحقوق الملكية",
        debtToEquity_comment_low: "هيكل آمن.",
        debtToEquity_comment_good: "توازن جيد.",
        debtToEquity_comment_high: "دين مرتفع.",
        debtToAssets: "نسبة الديون للأصول",
        debtToAssets_comment_low: "وضع آمن.",
        debtToAssets_comment_high: "مخاطر مرتفعة.",
        interestCoverageRatio: "عدد مرات تغطية الفوائد",
        interestCoverageRatio_comment_safe: "قدرة ممتازة.",
        interestCoverageRatio_comment_risk: "خطر.",
        financialLeverage: "الرافعة المالية",
        financialLeverage_comment_high: "اعتماد كبير.",
        financialLeverage_comment_low: "اعتماد منخفض.",
        netProfitMargin: "هامش صافي الربح",
        netProfitMargin_comment_high: "ربحية ممتازة.",
        netProfitMargin_comment_avg: "ربحية مقبولة.",
        netProfitMargin_comment_low: "خسائر.",
        grossProfitMargin: "نسبة مجمل الربح",
        grossProfitMargin_comment_high: "هامش قوي.",
        grossProfitMargin_comment_low: "هامش ضعيف.",
        roa: "العائد على الأصول (ROA)",
        roa_comment_high: "كفاءة عالية.",
        roa_comment_low: "كفاءة منخفضة.",
        roe: "العائد على حقوق الملكية (ROE)",
        roe_comment_high: "عائد ممتاز.",
        roe_comment_low: "عائد ضعيف.",
        eps: "ربحية السهم (EPS)",
        eps_comment_positive: "ربح للسهم.",
        eps_comment_negative: "خسارة للسهم.",
        peRatio: "مضاعف الربحية (P/E)",
        peRatio_comment: "يقارن بالقطاع.",
        pbRatio: "معدل السعر للقيمة الدفترية (P/B)",
        pbRatio_comment: "يقارن سعر السهم بقيمته الدفترية.",
        dividendYield: "معدل الربح الموزع للسهم",
        dividendYield_comment: "هام للمستثمرين الباحثين عن دخل.",
        payoutRatio: "نسبة التوزيع",
        payoutRatio_comment: "نسبة منخفضة قد تعني إعادة استثمار.",
        ...
        summary_ok: "الوضع المالي يبدو مستقرًا...",
        summary_risk: "توجد بعض مؤشرات الخطر...",
        alert_liquidity_risk: "🔴 خطر سيولة...",
        alert_leverage_risk: "🟡 تنبيه دين مرتفع...",
        alert_profit_risk: "🔴 خطر ربحية...",
        alert_ok: "🟢 لا توجد مؤشرات خطر حرجة...",
        noDataForRatios: "لا توجد بيانات كافية لحساب النسب.",
        ...
        errorPrice: "سعر البيع يجب أن يكون أعلى.",
        errorPositiveValues: "أدخل قيم موجبة.",
        revenue: "الإيرادات",
        totalCosts: "إجمالي التكاليف",
        fixedCosts: "التكاليف الثابتة",
        unitsSold: "الوحدات المباعة",
        value: "القيمة",
        dupontTitle: "تحليل دوبونت",
        dupontDesc: "تفكيك العائد على حقوق الملكية (ROE)...",
        dupontEquation: "معادلة دوبونت:",
        dupontCompNPM: "هامش صافي الربح",
        dupontCompAT: "دوران الأصول",
        dupontCompEM: "مضاعف الملكية",
        dupontCompROE: "العائد على الملكية",
        dupontDataWarning: "بيانات غير كافية لتحليل دوبونت (تأكد من تشغيل صفحة 'التقارير').",
        dupontInterpretationHighROE: "🟢 العائد المرتفع على حقوق الملكية مدفوع بشكل أساسي بـ:",
        dupontInterpretationLowROE: "🟡 العائد المنخفض على حقوق الملكية يتأثر بـ:",
        dupontFactorProfitability: "ربحية تشغيلية قوية (هامش ربح جيد).",
        dupontFactorEfficiency: "كفاءة أصول عالية (دوران أصول سريع).",
        dupontFactorLeverage: "استخدام الرفع المالي (مضاعف ملكية مرتفع).",
        dupontFactorLowProfitability: "ربحية تشغيلية ضعيفة (هامش ربح منخفض).",
        dupontFactorLowEfficiency: "كفاءة أصول منخفضة (دوران أصول بطيء).",
        dupontFactorLowLeverage: "اعتماد منخفض على الديون (مضاعف ملكية منخفض).",
        verticalTitle: "التحليل الرأسي",
        verticalDesc: "يعرض البنود كنسبة مئوية...",
        verticalDataWarning: "بيانات غير كافية للتحليل الرأسي (تأكد من تشغيل صفحة 'التقارير').",
        verticalBS: "الميزانية (% من الأصول)",
        verticalIS: "الدخل (% من الإيرادات)",
        verticalAccount: "الحساب",
        verticalValue: "القيمة",
        verticalPercent: "النسبة %",
        ...
        verticalLargestEquity: "أكبر بند حقوق الملكية هو {account} بنسبة {percent} (من إجمالي الخصوم وحقوق الملكية).",
        ...
        zscoreTitle: "نموذج Altman Z-Score",
        zscoreDesc: "نموذج للتنبؤ بالإفلاس...",
        zscoreDataWarning: "بيانات غير كافية لحساب Z-Score (تأكد من تشغيل صفحة 'التقارير').",
        zscoreValueLabel: "قيمة Z-Score:",
        zscoreInterpretation: "التفسير:",
        zscoreZoneSafe: "🟢 منطقة آمنة",
        zscoreZoneGrey: "🟡 منطقة رمادية",
        zscoreZoneDistress: "🔴 منطقة الخطر",
        zscoreComponents: "مكونات النموذج:",
        zscoreX1: "X1 (رأس المال العامل / الأصول)",
        zscoreX2: "X2 (الأرباح المحتجزة / الأصول)",
        zscoreX3: "X3 (الأرباح ق.ف.ض / الأصول)",
        zscoreX4: "X4 (حقوق الملكية / الخصوم)",
        zscoreX5: "X5 (الإيرادات / الأصول)",
        zscoreRetainedEarningsNotFound: "(أرباح محتجزة غير موجودة)",
        cfTitle: "تحليل التدفقات النقدية (تقديري)",
        cfDesc: "تقدير لقائمة التدفقات النقدية...",
        cfDataWarning: "بيانات غير كافية لتقدير التدفقات (تأكد من تشغيل صفحة 'التقارير').",
        cfStmtTitle: "قائمة التدفقات النقدية المقدرة",
        cfNetIncome: "صافي الدخل",
        cfDepreciationAmortization: "الإهلاك (مقدر)",
        cfChangesWC: "التغيرات في رأس المال العامل (مقدر)",
        cfOperating: "التدفق التشغيلي",
        cfInvesting: "التدفق الاستثماري (مقدر)",
        cfFinancing: "التدفق التمويلي (مقدر)",
        cfNetChange: "صافي التغير النقدي",
        cfRatiosTitle: "نسب التدفقات النقدية",
        cfRatioOCF: "نسبة التدفق التشغيلي",
        cfRatioFCF: "التدفق النقدي الحر (مقدر)",
        cfInterpretationPositiveOCF: "🟢 العمليات تولد نقدًا.",
        cfInterpretationNegativeOCF: "🔴 العمليات تستهلك نقدًا.",
        cfInterpretationFCF: "التدفق النقدي الحر...",
        evaInputTitle: "مدخلات حساب (EVA)",
        evaInputDesc: "يتطلب افتراضات خارجية.",
        labelWACC: "متوسط تكلفة رأس المال (WACC)",
        labelTaxRate: "معدل الضريبة",
        evaResultsTitle: "نتائج تحليل (EVA)",
        evaDataWarning: "بيانات غير كافية لحساب (EVA) (تأكد من تشغيل صفحة 'التقارير').",
        evaValueLabel: "القيمة الاقتصادية المضافة (EVA):",
        evaInterpretation: "التفسير:",
        evaInterpretationPositive: "🟢 خلق للقيمة.",
        evaInterpretationNegative: "🔴 تدمير للقيمة.",
        evaComponents: "مكونات الحساب:",
        evaNOPAT: "صافي الربح التشغيلي بعد الضرائب",
        evaInvestedCapital: "رأس المال المستثمر",
        ...
        horizontalDataWarning: "لا توجد بيانات فترة سابقة (financialDataPrevious). يرجى التأكد من إدخال بيانات الفترة السابقة وتشغيل صفحة 'التقارير'.",
        ...
        cccDataWarning: "بيانات غير كافية لحساب CCC (تأكد من تشغيل صفحة 'التقارير').",
        cccValueLabel: "دورة التحول النقدي (أيام):",
        cccInterpretation: "التفسير:",
        cccInterpretationShort: "🟢 دورة قصيرة: كفاءة عالية.",
        cccInterpretationLong: "🟡 دورة طويلة: بطء في بيع المخزون أو التحصيل.",
    ...
    en: {
        ...
        alert_liquidity_risk: "🔴 Liquidity Risk...",
        alert_leverage_risk: "🟡 High Debt Warning...",
        alert_profit_risk: "🔴 Profitability Risk...",
        alert_ok: "🟢 No critical risk indicators found...",
        ...
        zscoreZoneSafe: "🟢 Safe Zone",
        zscoreZoneGrey: "🟡 Grey Zone",
        zscoreZoneDistress: "🔴 Distress Zone",
        ...
        cfInterpretationPositiveOCF: "🟢 Operations generate cash.",
        cfInterpretationNegativeOCF: "🔴 Operations consume cash.",
        ...
        evaInterpretationPositive: "🟢 Value Creation.",
        evaInterpretationNegative: "🔴 Value Destruction.",
        ...
        cccInterpretationShort: "🟢 Short cycle: High efficiency.",
        cccInterpretationLong: "🟡 Long cycle: Slowness in selling inventory or collecting.",
...
window.pageTranslations = window.pageTranslations || {}, window.pageTranslations.ar = { ...window.pageTranslations.ar || {},
    ...
    setTimeout((() => {
        ...
        const e = {
            ...
            // --- (إصلاح تحليل التعادل والسيناريو) ---
            e.baseBreakeE = e.baseBreakeven;
        // --- (نهاية الإصلاح) ---

        // --- (تطوير) دالة حساب النسب (c) ---
        c = () => {
            ...
            try {
                const i = t.totalAssets || 0,
                    ...
                    M = D > 0 && u > 0 ? u / D : 1 / 0,
                    O = P > 0 ? l / P : 0,
                    // --- (تطوير) استخدام المبيعات الآجلة لدقة 100% ---
        ...
        u = (n, o, l) => {
            ...
            l.forEach((n => {
                const o = e.ratios[n];
                let l;
                l = "netWorkingCapital" === n ? s(o, 0) : ["avgCollectionPeriod", "daysInventoryOutstanding", "daysPayablesOutstanding", "cashConversionCycle"].includes(n) ? `${r(o,0)} ${"ar"===t?"يوم":"Days"}` : ["grossProfitMargin", "netProfitMargin", "roa", "roe", "dividendYield", "payoutRatio"].includes(n) ? i(o) : r(o, 2), isNaN(o) && (l = "N/A");
        ...
        g = () => {
            ...
            // (جديد) دالة مساعدة لتجميع بنود الميزانية من الهيكل الجديد
            const flattenBs = (bs) => {
                if (!bs) return [];
                return [
            ...
            const c = flattenBs(e.statementsCurrent.bs); // (تعديل) استخدام الدالة المساعدة
            var u;
            ...
            // (جديد) دالة مساعدة لتجميع بنود الدخل من الهيكل الجديد
            const flattenIs = (is) => {
                if (!is) return [];
                return [
                    ...(is.revenue || []),
            ...
            // (تعديل) منطق الاستنتاجات ليعمل مع الهيكل الجديد
            let p = "";
            const g = [],
        ...
        y = () => {
            ...
            // (جديد) دوال مساعدة لتجميع البيانات من الهيكل الجديد
            ...
            const o = flattenBs_h(e.statementsCurrent.bs); // (تعديل)
            const i = flattenBs_h(e.statementsPrevious.bs); // (تعديل)
            ...
            const c = flattenIs_h(e.statementsCurrent.is); // (تعديل)
            const u = flattenIs_h(e.statementsPrevious.is); // (تعديل)
        ...
        f = () => {
            ...
            if (isNaN(e.baseBreakeven.units) || isNaN(e.baseBreakeven.value))
                if (isFinite(i) && isFinite(r) && isFinite(c) && c > r) {
                    ...
                    const e = d();
                    if (isNaN(e?.units)) return void alert("ar" === t ? "يرجى إدخال قيم صالحة وحساب نقطة التعادل الأساسية أولاً في تبويب تحليل التعادل." : "Please enter valid values and calculate the base break-even point first in the Break-even Analysis tab.")
                }
